/**
 * Live preview for `social-links-bar`. Mirrors the `typescript` variant.
...
export function SocialLinksBar({ links = DEFAULT_LINKS, label = 'Follow us', className = '' }: SocialLinksBarProps) {
  return (
...
export default function SocialLinksBarPreview() {
  return (
    <SocialLinksBar
      links={[
        { platform: 'x', href: '#' },
