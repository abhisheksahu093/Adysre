...
/**
 * Live preview for `map-world-dotted`.
 *
...
export function MapWorldDotted({ markers = DEFAULT_MARKERS, className = '' }: MapWorldDottedProps) {
...
export default function MapWorldDottedPreview() {
  return <MapWorldDotted className="w-full" />;
}
