...
/**
 * Live preview for `carousel-basic`.
 *
 * Mirrors the `typescript` code variant with three sample slides. Interactive:
 * the arrows and dots move the track, off-screen slides are aria-hidden, and
 * the viewport is a polite live region.
...
export function CarouselBasic({ items, className = '', ariaLabel = 'Carousel' }: CarouselBasicProps) {
...
export default function CarouselBasicPreview() {
  return <CarouselBasic items={SAMPLE_SLIDES} ariaLabel="Product highlights" className="w-full" />;
}
