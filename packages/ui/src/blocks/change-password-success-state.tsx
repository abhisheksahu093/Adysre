...
export function ChangePasswordSuccessState({ onSubmit = () => {}, className = '' }: ChangePasswordSuccessStateProps) {
  const id = useId();
...
export default function ChangePasswordSuccessStatePreview() {
